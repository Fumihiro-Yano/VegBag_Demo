//
//  StemVegetablesCollectionViewController.swift
//  VegBag_Demo
//
...
class StemVegetablesCollectionViewController :  BaseCollectionViewController {
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cellmainImage = UIImage(named: "mood5.jpg")

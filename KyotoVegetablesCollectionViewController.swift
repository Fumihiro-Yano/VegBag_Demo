//
//  KyotoVegetablesCollectionViewController.swift
//  VegBag_Demo
//
...
class KyotoVegetablesCollectionViewController :  BaseCollectionViewController {
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cellmainImage = UIImage(named: "mood8.jpg")

//
//  FlowerVegetablesCollectionViewController.swift
//  VegBag_Demo
//
...
class FlowerVegetablesCollectionViewController :  BaseCollectionViewController {
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cellmainImage = UIImage(named: "mood4.jpg")
